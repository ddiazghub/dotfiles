...
-- [[ Splits ]]
vim.keymap.set('n', '<leader>%', '<Cmd>vsplit<CR>', { desc = 'Horizontal Split' })
vim.keymap.set('n', '<leader>"', '<Cmd>split<CR>', { desc = 'Vertical Split' })
...
local function smart_splits()
  ...
  vim.keymap.set('n', '<A-h>', require('smart-splits').resize_left, { desc = 'Resize Pane to the left' })
  ...
  vim.keymap.set({ 'n', 't' }, '<C-l>', require('smart-splits').move_cursor_right, { desc = 'Focus Pane to the right' })
  vim.keymap.set({ 'n', 't' }, '<C-\\>', require('smart-splits').move_cursor_previous, { desc = 'Focus Pane' })
  -- swapping buffers between windows
  vim.keymap.set('n', '<leader>mh', require('smart-splits').swap_buf_left, { desc = 'Swap with left Buffer' })
  vim.keymap.set('n', '<leader>mj', require('smart-splits').swap_buf_down, { desc = 'Swap with Buffer below' })
  vim.keymap.set('n', '<leader>mk', require('smart-splits').swap_buf_up, { desc = 'Swap with Buffer above' })
  vim.keymap.set('n', '<leader>ml', require('smart-splits').swap_buf_right, { desc = 'Swap with right Buffer' })
end
