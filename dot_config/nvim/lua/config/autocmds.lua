...
vim.api.nvim_create_autocmd('FileType', {
  ...
  callback = function(ev)
    ...
    if vim.api.nvim_win_get_config(win).relative ~= '' then
      ...
      vim.keymap.set('n', 'q', oil.close, { buffer = ev.buf, desc = 'Close Oil Buffer' })
      vim.keymap.set('n', '<esc>', oil.close, { buffer = ev.buf, desc = 'Close Oil Buffer' })
    end
  end,
})

-- If no other listed buffers remain, open oil.nvim in the CWD
